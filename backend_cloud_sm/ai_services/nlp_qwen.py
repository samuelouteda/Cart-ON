...
class NLPQwen:
    ...
    def parse_intent(self, text: str, modo: str = "supermercado"):
        ...
        try:
            ...
            # Limpieza del bloque de código JSON por seguridad (Anti-alucinaciones)
            if "```" in raw_text:
    ...
    def generate_response(self, user_text: str, context: str) -> dict:
        ...
        try:
            ...
            return {
                "texto": "He procesado la tarea, pero tengo un pequeño cruce de cables en mi expresión.",
                "emocion": "duda"
            }